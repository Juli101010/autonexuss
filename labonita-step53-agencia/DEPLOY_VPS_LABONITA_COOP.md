...
```powershell
scp "C:\Users\Julian\OneDrive\Documentos\New project\dist-labonita\labonita-runtime-vps-20260518-150438.zip" root@46.224.27.229:/opt/labonita-release.zip
```
...
cd /opt/labonita/backend
npm ci --omit=dev
pm2 start server.js --name labonita-backend --cwd /opt/labonita/backend --update-env
pm2 save
```
...
## Paquete runtime limpio actual

Este deploy debe usar:

`	xt
C:\Users\Julian\OneDrive\Documentos\New project\dist-labonita\labonita-runtime-vps-20260518-150438.zip
` 

El paquete runtime excluye: .env, database.sqlite, illing.sqlite, 
ode_modules, logs, temporales, gency-control y entrega-labonita-agencia.
