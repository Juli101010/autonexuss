...
router.get('/ops/templates', requireUser, opsCtrl.templates);
router.get('/ops/my/petitions', requireUser, opsCtrl.listMine);
router.post('/ops/my/petitions', requireUser, opsCtrl.createMine);
router.get('/ops/my/petitions/:id', requireUser, opsCtrl.detailMine);
router.put('/ops/my/petitions/:id', requireUser, opsCtrl.updateMine);
router.post('/ops/my/petitions/:id/submit', requireUser, opsCtrl.submitMine);
router.get('/ops/my/petitions/:id/filled-form.pdf', requireUser, opsCtrl.downloadFilledFormMine);
