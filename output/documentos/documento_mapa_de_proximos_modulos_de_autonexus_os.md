# Mapa de próximos módulos de Autonexus OS
...
Definir los próximos módulos que debe construir Autonexus OS: documentos, web, automatizaciones, scraping, GitHub, memoria, panel visual y orquesta de agentes.
