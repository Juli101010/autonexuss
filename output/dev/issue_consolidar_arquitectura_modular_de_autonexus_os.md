# Issue Dev: Consolidar arquitectura modular de Autonexus OS
...
mejora de arquitectura interna
...
Ordenar los módulos actuales de Autonexus OS: Odoo, documentos, WebDev, automatizaciones, investigación, auto-mejora, panel, tareas y grafo.
...
scripts; brain; output; ui; releases; TASKS.md; graph/events.json
