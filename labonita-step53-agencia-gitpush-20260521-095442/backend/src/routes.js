...
const demoCtrl = require('./modules/demo/demo.controller');
const backupsCtrl = require('./modules/backups/backups.controller');
...
/* ================= DEMO / TUTORIAL INTEGRAL (ADMIN) ================= */
router.post('/admin/demo/integral', requireAdmin, demoCtrl.runIntegral);

/* ================= BACKUPS (ADMIN) ================= */
router.post('/admin/backups', requireAdmin, backupsCtrl.createManual);
router.post('/admin/backups/download', requireAdmin, backupsCtrl.download);
...
/* ================= PROFILE (ARTIST) ================= */
router.get('/profile/me', requireUser, profileCtrl.getMe);
router.put('/profile/me', requireUser, profileCtrl.upsertMe);
