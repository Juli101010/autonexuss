...
robocopy $Source $stage /E /R:1 /W:1 `
  /XD ".git" ".github" ".vscode" ".idea" "node_modules" "agency-control" "entrega-labonita-agencia" "_tmp_step57" "tmp_e2e_step57" "tmp_e2e_step57_min" "test-results" "uploads" "dist-labonita" `
  /XF ".env" ".env.local" ".env.production" ".env.development" "*.log" "*.err.log" "*.out.log" "*.sqlite" "*.sqlite-*" "*.db" "*.zip" "tmp-live-e2e.js" "delsol-discovery-readonly.json"
